...
//        JMXServiceURL url = new JMXServiceURL("service:jmx:rmi:///jndi/rmi://192.168.31.236:9001/jmxrmi");
        ...
        List<OperatingSystemMXBean> operatingSystemMXBeanList = ManagementFactory.getPlatformMXBeans(serverConnection, OperatingSystemMXBean.class);
        operatingSystemMXBeanList.forEach(operatingSystemMXBean -> {
